...
| `/compress`          | Compress context by summarizing history  |
...
| `--output-format`                | `-o`  | string  | `text`    | The format of the CLI output. Choices: `text`, `json`, [`stream-json`](stream-json-specification.md)                                                                                                   |
...
| ------------ | -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| `auto`       | `gemini-2.5-pro` or `gemini-3.1-pro-preview` | **Default.** Resolves to the preview model if preview features are enabled, otherwise resolves to the standard pro model. |
| `pro`        | `gemini-2.5-pro` or `gemini-3.1-pro-preview` | For complex reasoning tasks. Uses preview model if enabled.                                                               |
...
When using the `--model` flag, you can specify one of the following concrete model names:
